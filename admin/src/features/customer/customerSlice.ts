...
export const customerSlice = createSlice({
  ...
  reducers: {
    ...
    // ** Get list address customer
    getAddressCustomerStart: (state) => {
      state.listAddress.loading = true;
    },
    getAddressCustomerSuccess: (state, action) => {
      state.listAddress.loading = false;
      state.listAddress.result = action.payload;
      state.listAddress.error = false;
    },
    getAddressCustomerFailed: (state, action) => {
      state.listAddress.loading = false;
      state.listAddress.result = action.payload;
      state.listAddress.error = true;
    },
  },
});
